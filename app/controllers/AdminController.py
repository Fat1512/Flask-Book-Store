...
def admin_home():
    ...
    return render_template("/admin/adminHome.html", total_revenue=total_revenue, book=book, book_gerne=book_gerne,
...
def admin_config():
    con = config()
    return render_template("/admin/adminConfig.html", config=con)
